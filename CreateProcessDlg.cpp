...
BEGIN_MESSAGE_MAP(CCreateProcessDlg, CDialogEx)
	...
	ON_WM_PAINT()
	ON_WM_QUERYDRAGICON()
	ON_BN_CLICKED(IDC_BUTTON, &CCreateProcessDlg::OnBnClickedButton)
	...
	ON_BN_CLICKED(IDC_BUTTON5, &CCreateProcessDlg::OnBnClickedButton5)
END_MESSAGE_MAP()
...
void CCreateProcessDlg::OnBnClickedButton()//동기 
{
...
void CCreateProcessDlg::OnBnClickedButton2()//비동기
{
...
void CCreateProcessDlg::OnBnClickedButton4() // 자살
{
	//ExitProcess(0);
	TerminateProcess(GetCurrentProcess(), 0);
	AfxMessageBox(_T("이 프로그램은 종료됩니다.")); // 수행되지 않는다.
}


void CCreateProcessDlg::OnBnClickedButton5() // 타살
{
	STARTUPINFO si = { sizeof(STARTUPINFO), };
	PROCESS_INFORMATION pi;
